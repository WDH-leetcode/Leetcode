...
f_handle = pandas.read_csv('data\credit_train.csv')
N = f_handle.shape[0]
D = f_handle.shape[1]
...
# credit: https://www.kaggle.com/shashankasubrahmanya/missing-data-imputation-using-regression
X_train_para = {}
...
print('results for credit_test is added to the last column, 0 is paid off, 1 is charged off.')